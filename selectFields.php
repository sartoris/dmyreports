  ...
  <head>
    ...
    <script language="javascript" type="text/javascript">
      ...
      function jumpURL(tmpURL) {
        doAjax('setSessionVariables.php','selectedFields=' + selectedFields.value,null,'post',0,null);
  ...
  <body onLoad="initVars();" bgcolor="#dcdedb">
    <table width="701" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="668" valign="top" bgcolor="#FBF9F9">
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="pageHeader"><?php echo $pageTitle;?> - Select Fields </td>
            </tr>
          </table>
          <table width="100%"  border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
              <td height="27">
                <table width="300" border="0" align="center" cellpadding="5" cellspacing="0" class="tableBorders">
                  <!--DWLayoutTable-->
                  <tr>
                    <td width="150" class="tableHeader">Select Table</td>
                    <td width="150" class="tableHeader">Select Fields</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="19" colspan="2" valign="top">
                      <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="270">
                            <select name="lstSelectedFields" size="5" multiple="multiple" id="lstSelectedFields" style="width:270px">
                              <?php
                  ...
                  <tr>
                    <td height="19" colspan="2" valign="top"><input name="cmdNew" type="button" class="button" id="cmdNew" style="width:300px" onclick="cmdNew_onClick();" value="Start Over"/></td>
                  </tr>
                  <tr>
                    <td height="19" colspan="2" valign="top">
                        ...
                        <div align="right">
                          <table width="300" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td><input name="cmdNext" type="submit" class="button" id="cmdNext" style="width:150px" value="Next &gt;&gt;" <?php if(isset($_SESSION['selectedFields']) && $_SESSION['selectedFields']==""){ echo ("disabled='disabled'"); } ?>/></td>
                            </tr>
                          </table>
                          <input name="selectedFields" type="hidden" id="selectedFields" value="<?Php if(isset($_SESSION['selectedFields'])) echo($_SESSION['selectedFields']);?>" />
                        </div>
                      </form>
                    </td>
                  </tr>
