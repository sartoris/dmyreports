<?php
  ...
  $recReports = mysqli_query($connReports, $query_limit_recReports) or die(mysqli_error());
  $row_recReports = mysqli_fetch_assoc($recReports);

  if (isset($_GET['totalRows_recReports'])) {
    $totalRows_recReports = $_GET['totalRows_recReports'];
  } else { 
    $all_recReports = mysqli_query($connReports, $query_recReports);
      ...
      <tr>
        ...
        <td valign="top" bgcolor="#FBF9F9">
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="pageHeader"><?php echo $pageTitle;?> - Create / View Reports </td>
            </tr>
          </table>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <tr>
                  <td height="222"><br>
                    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td valign="top">
                          <table width="300" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorders">
                            <tr>
                            ...
                            <tr>
                              <td height="53" valign="top">
                                <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td height="15">
                                      <div align="center" class="tableNav">Records <?php echo ($startRow_recReports + 1) ?> to <?php echo min($startRow_recReports + $maxRows_recReports, $totalRows_recReports) ?> of <?php echo $totalRows_recReports ?> </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <?php if ($pageNum_recReports > 0 || $pageNum_recReports < $totalPages_recReports) { ?>
                                    <td height="15" class="tableNav">
                          ...
                          <td>&nbsp;</td>
                          <td valign="top">
                            <div onClick="window.location='selectTables.php';" style="cursor:pointer">
